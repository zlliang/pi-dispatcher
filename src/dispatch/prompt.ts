...
export const SYSTEM_PROMPT = [
  ...
  "- The `Current model` field in <session> is only the model currently selected for the session and may just come from the configured default. Do not treat it as a preference or as a basis for the choice.",
